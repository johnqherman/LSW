...
pub fn write_cmake_toolchain_file(
    ...
    let _ = write!(text, "set(CMAKE_SYSTEM_PROCESSOR {processor})\n");
    let _ = write!(
        text,
    ...
    let _ = write!(text, "set(CMAKE_C_FLAGS_INIT \"{c_flags}\")\n");
    let _ = write!(text, "set(CMAKE_CXX_FLAGS_INIT \"{cxx_flags}\")\n");
    let _ = write!(text, "set(CMAKE_EXE_LINKER_FLAGS_INIT \"{link_flags}\")\n");
    let _ = write!(
        text,
